...
/* 
 * source: 00-reporting_db-add_new_synonyms.sql 
 */
CREATE OR REPLACE SYNONYM NODE_RCRA_HD_EPISODIC_PRJT FOR NODE_FLOW_RCRA.RCRA_HD_EPISODIC_PRJT
/


/* 
 * source: 01-reporting_db-add_new_objs.sql 
 */
...
--  Add Table:  RCRA_HD_EPISODIC_PRJT
CREATE TABLE RCRA_HD_EPISODIC_PRJT
(
    HD_EPISODIC_PRJT_ID int NOT NULL,
...
-- increase length of WASTE_CODE_TEXT
 ...
 */
-- recompile view
CREATE OR REPLACE VIEW ETL_HD_EPISODIC_EVENT AS
(
...
-- new view
CREATE OR REPLACE VIEW ETL_HD_EPISODIC_PRJT AS
(
...
-- recompile view
CREATE OR REPLACE VIEW ETL_RU_REPORT_UNIV_VW AS
(
...
-- recompile the view
CREATE OR REPLACE VIEW ETL_PRM_MOD_EVENT_VW AS
(
...
/* 
 * source: 03-reporting_db-package.sql 
 */
