...
create sequence SEQ_RCRA_EM_HANDLER
    /

create sequence SEQ_RCRA_EM_WASTE
    /

create sequence SEQ_RCRA_EM_TR_NUM_ORIG
    /

create sequence SEQ_RCRA_EM_TR_NUM_REJ
    /

create sequence SEQ_RCRA_EM_TR_NUM_RESIDUE_NEW
    /

create sequence SEQ_RCRA_EM_TR_NUM_WASTE
    /

create sequence SEQ_RCRA_EM_WASTE_CD_FED
    /
...
create sequence SEQ_RCRA_EM_WASTE_CD_TSDF
    /
...
(
    ...
    CURRENT_COST_ESTIMATE_IND   CHAR(1),
    LAST_UPDT_BY                VARCHAR2(255),
    LAST_UPDT_DATE              DATE
)
    /
...
(
    ...
    F_CREATED_DATE               TIMESTAMP(6),
    DATA_ORIG                    CHAR(2),
    FAC_FACE_VAL_AMOUNT          DECIMAL(14,6),
    ALT_IND                      CHAR(1),
    LAST_UPDT_BY                 VARCHAR2(255),
    LAST_UPDT_DATE               DATE
)
...
(
    EM_HANDLER_ID          NUMBER       not null
        constraint PK_RCRA_EM_HANDLER
            primary key,
    EM_EMANIFEST_ID        NUMBER       not null
        constraint FK_RCRA_EM_HANDLER_PARENT
            references RCRA_EM_EMANIFEST
            on delete cascade,
...
(
    ...
    EM_EMANIFEST_ID       NUMBER not null
        constraint FK_RCRA_EM_WASTE_PARENT
            references RCRA_EM_EMANIFEST
            on delete cascade,
    DOT_HAZ_IND           CHAR   not null,
    WASTES_DESC           VARCHAR2(500),
    BR_IND                CHAR,
    PCB_IND               CHAR   not null,
...
(
    EM_TR_NUM_ORIG_ID     NUMBER       not null
        constraint PK_RCRA_EM_TR_NUM_ORIG
            primary key,
    EM_EMANIFEST_ID       NUMBER       not null
        constraint FK_RCRA_EM_TR_NUM_EMAN_PARENT
            references RCRA_EM_EMANIFEST
            on delete cascade,
...
(
    EM_TR_NUM_REJ_ID      NUMBER       not null
        constraint PK_RCRA_EM_TR_NUM_REJ
            primary key,
    EM_EMANIFEST_ID       NUMBER       not null
        constraint FK_RCRA_EM_TR_NUM_REJ_PARENT
            references RCRA_EM_EMANIFEST
            on delete cascade,
    MANIFEST_TRACKING_NUM VARCHAR2(12) not null
)
...
(
    EM_TR_NUM_RESIDUE_NEW_ID NUMBER       not null
        constraint PK_RCRA_EM_TR_NUM_RESIDUE_NEW
            primary key,
    EM_EMANIFEST_ID          NUMBER       not null
        constraint FK_RCRA_EM_TR_NUM_RES_PARENT
            references RCRA_EM_EMANIFEST
            on delete cascade,
    MANIFEST_TRACKING_NUM    VARCHAR2(12) not null
)
...
(
    EM_TR_NUM_WASTE_ID    NUMBER       not null
        constraint PK_RCRA_EM_TR_NUM_WASTE
            primary key,
    EM_WASTE_ID           NUMBER       not null
        constraint FK_RCRA_EM_TR_NUM_WASTE_PARENT
...
(
    EM_WASTE_CD_FED_ID NUMBER      not null
        constraint PK_RCRA_EM_WASTE_CD_FED
            primary key,
    EM_WASTE_ID        NUMBER      not null
        constraint FK_RCRA_EM_WASTE_CD_FED_PARENT
            references RCRA_EM_WASTE
            on delete cascade,
...
(
    EM_WASTE_CD_GEN_ID NUMBER      not null
        constraint PK_RCRA_EM_WASTE_CD_GEN
            primary key,
    EM_WASTE_ID        NUMBER      not null
        constraint FK_RCRA_EM_WASTE_CD_GEN_PARENT
            references RCRA_EM_WASTE
            on delete cascade,
    WASTE_CODE         VARCHAR2(6) not null,
    WASTE_DESC         VARCHAR2(2000)
...
(
    EM_WASTE_CD_TSDF_ID NUMBER      not null
        constraint PK_RCRA_EM_WASTE_CD_TSDF
            primary key,
    EM_WASTE_ID         NUMBER      not null
        constraint FK_RCRA_EM_WASTE_CD_TSDF_PAR
            references RCRA_EM_WASTE
            on delete cascade,
    WASTE_CODE          VARCHAR2(6) not null,
    WASTE_DESC          VARCHAR2(2000)
...
create synonym NODE_RCRA_SUBMISSIONHISTORY for RCRA_OUTBOUND.RCRA_SUBMISSIONHISTORY
    /

create synonym NODE_RCRA_PRM_SUBM for RCRA_OUTBOUND.RCRA_PRM_SUBM
    /

create synonym NODE_RCRA_HD_SUBM for RCRA_OUTBOUND.RCRA_HD_SUBM
    /

create synonym NODE_RCRA_GIS_SUBM for RCRA_OUTBOUND.RCRA_GIS_SUBM
    /

create synonym NODE_RCRA_FA_SUBM for RCRA_OUTBOUND.RCRA_FA_SUBM
    /

create synonym NODE_RCRA_CME_SUBM for RCRA_OUTBOUND.RCRA_CME_SUBM
    /

create synonym NODE_RCRA_CA_SUBM for RCRA_OUTBOUND.RCRA_CA_SUBM
    /

create synonym NODE_RCRA_CME_FAC_SUBM for RCRA_OUTBOUND.RCRA_CME_FAC_SUBM
    /
...
create synonym NODE_RCRA_CA_FAC_SUBM for RCRA_OUTBOUND.RCRA_CA_FAC_SUBM
    /
...
create synonym NODE_RCRA_GIS_FAC_SUBM for RCRA_OUTBOUND.RCRA_GIS_FAC_SUBM
    /
...
create synonym NODE_RCRA_FA_FAC_SUBM for RCRA_OUTBOUND.RCRA_FA_FAC_SUBM
    /
...
create synonym NODE_RCRA_HD_HBASIC for RCRA_OUTBOUND.RCRA_HD_HBASIC
    /
...
create synonym NODE_RCRA_PRM_FAC_SUBM for RCRA_OUTBOUND.RCRA_PRM_FAC_SUBM
    /
...
create synonym NODE_RCRA_PRM_SERIES for RCRA_OUTBOUND.RCRA_PRM_SERIES
    /
...
create synonym NODE_RCRA_PRM_UNIT for RCRA_OUTBOUND.RCRA_PRM_UNIT
    /
...
create synonym NODE_RCRA_GIS_GEO_INFORMATION for RCRA_OUTBOUND.RCRA_GIS_GEO_INFORMATION
    /
...
create synonym NODE_RCRA_HD_OTHER_ID for RCRA_OUTBOUND.RCRA_HD_OTHER_ID
    /
...
create synonym NODE_RCRA_HD_HANDLER for RCRA_OUTBOUND.RCRA_HD_HANDLER
    /
...
create synonym NODE_RCRA_CA_AREA for RCRA_OUTBOUND.RCRA_CA_AREA
    /
...
create synonym NODE_RCRA_CME_VIOL for RCRA_OUTBOUND.RCRA_CME_VIOL
    /
...
create synonym NODE_RCRA_FA_MECHANISM for RCRA_OUTBOUND.RCRA_FA_MECHANISM
    /
...
create synonym NODE_RCRA_FA_COST_EST for RCRA_OUTBOUND.RCRA_FA_COST_EST
    /
...
create synonym NODE_RCRA_CA_EVENT for RCRA_OUTBOUND.RCRA_CA_EVENT
    /
...
create synonym NODE_RCRA_CA_AUTHORITY for RCRA_OUTBOUND.RCRA_CA_AUTHORITY
    /
...
create synonym NODE_RCRA_CME_EVAL for RCRA_OUTBOUND.RCRA_CME_EVAL
    /
...
create synonym NODE_RCRA_CME_ENFRC_ACT for RCRA_OUTBOUND.RCRA_CME_ENFRC_ACT
    /
...
create synonym NODE_RCRA_CME_CSNY_DATE for RCRA_OUTBOUND.RCRA_CME_CSNY_DATE
    /
...
create synonym NODE_RCRA_CME_CITATION for RCRA_OUTBOUND.RCRA_CME_CITATION
    /
...
create synonym NODE_RCRA_CA_EVENT_COMMITMENT for RCRA_OUTBOUND.RCRA_CA_EVENT_COMMITMENT
    /
...
create synonym NODE_RCRA_CA_AUTH_REL_EVENT for RCRA_OUTBOUND.RCRA_CA_AUTH_REL_EVENT
    /
...
create synonym NODE_RCRA_CA_AREA_REL_EVENT for RCRA_OUTBOUND.RCRA_CA_AREA_REL_EVENT
    /
...
create synonym NODE_RCRA_CME_EVAL_VIOL for RCRA_OUTBOUND.RCRA_CME_EVAL_VIOL
    /
...
create synonym NODE_RCRA_CME_EVAL_COMMIT for RCRA_OUTBOUND.RCRA_CME_EVAL_COMMIT
    /
...
create synonym NODE_RCRA_CA_REL_PERMIT_UNIT for RCRA_OUTBOUND.RCRA_CA_REL_PERMIT_UNIT
    /
...
create synonym NODE_RCRA_CME_PNLTY for RCRA_OUTBOUND.RCRA_CME_PNLTY
    /
...
create synonym NODE_RCRA_CME_MILESTONE for RCRA_OUTBOUND.RCRA_CME_MILESTONE
    /
...
create synonym NODE_RCRA_CME_MEDIA for RCRA_OUTBOUND.RCRA_CME_MEDIA
    /
...
create synonym NODE_RCRA_CME_RQST for RCRA_OUTBOUND.RCRA_CME_RQST
    /
...
create synonym NODE_RCRA_FA_MECHANISM_DETAIL for RCRA_OUTBOUND.RCRA_FA_MECHANISM_DETAIL
    /
...
create synonym NODE_RCRA_CME_VIOL_ENFRC for RCRA_OUTBOUND.RCRA_CME_VIOL_ENFRC
    /
...
create synonym NODE_RCRA_CME_SUPP_ENVR_PRJT for RCRA_OUTBOUND.RCRA_CME_SUPP_ENVR_PRJT
    /
...
create synonym NODE_RCRA_HD_ENV_PERMIT for RCRA_OUTBOUND.RCRA_HD_ENV_PERMIT
    /
...
create synonym NODE_RCRA_HD_CERTIFICATION for RCRA_OUTBOUND.RCRA_HD_CERTIFICATION
    /
...
create synonym NODE_RCRA_HD_NAICS for RCRA_OUTBOUND.RCRA_HD_NAICS
    /
...
create synonym NODE_RCRA_HD_STATE_ACTIVITY for RCRA_OUTBOUND.RCRA_HD_STATE_ACTIVITY
    /
...
create synonym NODE_RCRA_PRM_EVENT for RCRA_OUTBOUND.RCRA_PRM_EVENT
    /
...
create synonym NODE_RCRA_HD_WASTE_CODE for RCRA_OUTBOUND.RCRA_HD_WASTE_CODE
    /
...
create synonym NODE_RCRA_HD_UNIVERSAL_WASTE for RCRA_OUTBOUND.RCRA_HD_UNIVERSAL_WASTE
    /
...
create synonym NODE_RCRA_HD_OWNEROP for RCRA_OUTBOUND.RCRA_HD_OWNEROP
    /
...
create synonym NODE_RCRA_PRM_UNIT_DETAIL for RCRA_OUTBOUND.RCRA_PRM_UNIT_DETAIL
    /
...
create synonym NODE_RCRA_PRM_WASTE_CODE for RCRA_OUTBOUND.RCRA_PRM_WASTE_CODE
    /
...
create synonym NODE_RCRA_PRM_RELATED_EVENT for RCRA_OUTBOUND.RCRA_PRM_RELATED_EVENT
    /
...
create synonym NODE_RCRA_PRM_EVENT_COMMITMENT for RCRA_OUTBOUND.RCRA_PRM_EVENT_COMMITMENT
    /
...
create synonym NODE_RCRA_HD_SEC_WASTE_CODE for RCRA_OUTBOUND.RCRA_HD_SEC_WASTE_CODE
    /

create synonym NODE_RCRA_CME_PYMT for RCRA_OUTBOUND.RCRA_CME_PYMT
    /
...
create synonym NODE_RCRA_HD_LQG_CLOSURE for RCRA_OUTBOUND.RCRA_HD_LQG_CLOSURE
    /
...
create synonym NODE_RCRA_HD_LQG_CONSOLIDATION for RCRA_OUTBOUND.RCRA_HD_LQG_CONSOLIDATION
    /
...
create synonym NODE_RCRA_HD_EPISODIC_EVENT for RCRA_OUTBOUND.RCRA_HD_EPISODIC_EVENT
    /
...
create synonym NODE_RCRA_HD_EPISODIC_WASTE for RCRA_OUTBOUND.RCRA_HD_EPISODIC_WASTE
    /
...
create synonym NODE_RCRA_RU_SUBM for RCRA_OUTBOUND.RCRA_RU_SUBM
    /

create synonym NODE_RCRA_RU_REPORT_UNIV_SUBM for RCRA_OUTBOUND.RCRA_RU_REPORT_UNIV_SUBM
    /

create synonym NODE_RCRA_RU_REPORT_UNIV for RCRA_OUTBOUND.RCRA_RU_REPORT_UNIV
    /
...
create synonym NODE_RCRA_EM_EMANIFEST for RCRA_OUTBOUND.RCRA_EM_EMANIFEST
    /
...
create synonym NODE_RCRA_EM_EMANIFEST_COMMENT for RCRA_OUTBOUND.RCRA_EM_EMANIFEST_COMMENT
    /
...
create synonym NODE_RCRA_EM_HANDLER for RCRA_OUTBOUND.RCRA_EM_HANDLER
    /

create view ETL_EM_HANDLER_VW as
(
SELECT ETL.WH_EM_EMANIFEST_ID,
       ETL.EM_SUBM_ID,
       NODE."EM_HANDLER_ID",
...
create synonym NODE_RCRA_EM_SUBM for RCRA_OUTBOUND.RCRA_EM_SUBM
    /

create synonym NODE_RCRA_EM_TR_NUM_ORIG for RCRA_OUTBOUND.RCRA_EM_TR_NUM_ORIG
    /

create view ETL_EM_TR_NUM_ORIG_VW as
(
SELECT ETL.WH_EM_EMANIFEST_ID,
       ETL.EM_SUBM_ID,
       NODE."EM_TR_NUM_ORIG_ID",
       NODE."EM_EMANIFEST_ID",
       NODE."MANIFEST_TRACKING_NUM"
FROM NODE_RCRA_EM_TR_NUM_ORIG NODE
         INNER JOIN ETL_EM_EMANIFEST_VW ETL ON ETL.EM_EMANIFEST_ID = NODE.EM_EMANIFEST_ID
    )
    /

create synonym NODE_RCRA_EM_TR_NUM_REJ for RCRA_OUTBOUND.RCRA_EM_TR_NUM_REJ
    /

create view ETL_EM_TR_NUM_REJ_VW as
(
SELECT ETL.WH_EM_EMANIFEST_ID,
       NODE."EM_TR_NUM_REJ_ID",
       NODE."EM_EMANIFEST_ID",
       NODE."MANIFEST_TRACKING_NUM"
...
create synonym NODE_RCRA_EM_TR_NUM_WASTE for RCRA_OUTBOUND.RCRA_EM_TR_NUM_WASTE
    /

create synonym NODE_RCRA_EM_WASTE for RCRA_OUTBOUND.RCRA_EM_WASTE
    /
...
create view ETL_EM_TR_NUM_WASTE_VW as
(
SELECT ETL.WH_EM_WASTE_ID,
       ETL.WH_EM_EMANIFEST_ID,
       ETL.EM_SUBM_ID,
       NODE."EM_TR_NUM_WASTE_ID",
       NODE."EM_WASTE_ID",
       NODE."MANIFEST_TRACKING_NUM"
...
create synonym NODE_RCRA_EM_WASTE_CD_FED for RCRA_OUTBOUND.RCRA_EM_WASTE_CD_FED
    /

create view ETL_EM_WASTE_CD_FED_VW as
(
SELECT ETL.WH_EM_WASTE_ID,
       ETL.WH_EM_EMANIFEST_ID,
       ETL.EM_SUBM_ID,
       NODE."EM_WASTE_CD_FED_ID",
       NODE."EM_WASTE_ID",
       NODE."WASTE_CODE",
       NODE."WASTE_DESC"
...
create synonym NODE_RCRA_EM_WASTE_CD_GEN for RCRA_OUTBOUND.RCRA_EM_WASTE_CD_GEN
    /

create view ETL_EM_WASTE_CD_GEN_VW as
(
SELECT ETL.WH_EM_WASTE_ID,
       ETL.WH_EM_EMANIFEST_ID,
       ETL.EM_SUBM_ID,
       NODE."EM_WASTE_CD_GEN_ID",
       NODE."EM_WASTE_ID",
       NODE."WASTE_CODE",
       NODE."WASTE_DESC"
...
create synonym NODE_RCRA_EM_WASTE_CD_TRANS for RCRA_OUTBOUND.RCRA_EM_WASTE_CD_TRANS
    /
...
create synonym NODE_RCRA_EM_WASTE_CD_TSDF for RCRA_OUTBOUND.RCRA_EM_WASTE_CD_TSDF
    /

create view ETL_EM_WASTE_CD_TSDF_VW as
(
SELECT ETL.WH_EM_WASTE_ID,
       ETL.WH_EM_EMANIFEST_ID,
       ETL.EM_SUBM_ID,
       NODE."EM_WASTE_CD_TSDF_ID",
       NODE."EM_WASTE_ID",
       NODE."WASTE_CODE",
       NODE."WASTE_DESC"
...
create synonym NODE_RCRA_EM_WASTE_COMMENT for RCRA_OUTBOUND.RCRA_EM_WASTE_COMMENT
    /
...
create synonym NODE_RCRA_EM_WASTE_PCB for RCRA_OUTBOUND.RCRA_EM_WASTE_PCB
    /
...
SELECT ETL.WH_EM_WASTE_ID,
       ETL.WH_EM_EMANIFEST_ID,
       ETL.EM_SUBM_ID,
       NODE."EM_WASTE_PCB_ID",
       NODE."EM_WASTE_ID",
       NODE."PCB_LOAD_TYPE_CODE",
       NODE."PCB_ARTICLE_CONT_ID",
       NODE."PCB_REMOVAL_DATE",
       NODE."PCB_WEIGHT",
       NODE."PCB_WASTE_TYPE",
       NODE."PCB_BULK_IDENTITY"
FROM NODE_RCRA_EM_WASTE_PCB NODE
         INNER JOIN ETL_EM_WASTE_VW ETL ON ETL.EM_WASTE_ID = NODE.EM_WASTE_ID
    )
    /

create synonym NODE_RCRA_CA_STATUTORY_CITAT for RCRA_OUTBOUND.RCRA_CA_STATUTORY_CITATION
    /
...
create synonym NODE_RCRA_FA_COST_EST_REL_MECH for RCRA_OUTBOUND.RCRA_FA_COST_EST_REL_MECHANISM
    /
...
create synonym NODE_RCRA_HD_SEC_MATERIAL_ACT for RCRA_OUTBOUND.RCRA_HD_SEC_MATERIAL_ACTIVITY
    /
...
create synonym NODE_RCRA_EM_TR_NUM_RES_NEW for RCRA_OUTBOUND.RCRA_EM_TR_NUM_RESIDUE_NEW
    /

create view ETL_EM_TR_NUM_RESIDUE_NEW_VW as
(
SELECT ETL.WH_EM_EMANIFEST_ID,
       NODE."EM_TR_NUM_RESIDUE_NEW_ID",
       NODE."EM_EMANIFEST_ID",
       NODE."MANIFEST_TRACKING_NUM"
FROM NODE_RCRA_EM_TR_NUM_RES_NEW NODE
         INNER JOIN ETL_EM_EMANIFEST_VW ETL ON ETL.EM_EMANIFEST_ID = NODE.EM_EMANIFEST_ID
    )
    /

create synonym NODE_RCRA_HD_EPISODIC_WASTE_CD for RCRA_OUTBOUND.RCRA_HD_EPISODIC_WASTE_CODE
    /
...
create synonym NODE_RCRA_HANDLER for RCRA_OUTBOUND.RCRA_HANDLER
    /

create synonym NODE_RCRA_LOCADDRESS for RCRA_OUTBOUND.RCRA_LOCADDRESS
    /

create synonym NODE_RCRA_MAILINGADDRESS for RCRA_OUTBOUND.RCRA_MAILINGADDRESS
    /

create synonym NODE_RCRA_CONTACTADDRESS for RCRA_OUTBOUND.RCRA_CONTACTADDRESS
    /

create synonym NODE_RCRA_CONTACT for RCRA_OUTBOUND.RCRA_CONTACT
    /

create synonym NODE_RCRA_FACSUB for RCRA_OUTBOUND.RCRA_FACSUB
    /

create synonym NODE_RCRA_USEDOIL for RCRA_OUTBOUND.RCRA_USEDOIL
    /

create synonym NODE_RCRA_LABHZRDWASTE for RCRA_OUTBOUND.RCRA_LABHZRDWASTE
    /

create synonym NODE_RCRA_SITEWASTEACT for RCRA_OUTBOUND.RCRA_SITEWASTEACT
    /

create synonym NODE_RCRA_HZRDSECONDARYMTRL for RCRA_OUTBOUND.RCRA_HZRDSECONDARYMTRL
    /

create synonym NODE_RCRA_NAICS for RCRA_OUTBOUND.RCRA_NAICS
    /

create synonym NODE_RCRA_CERT for RCRA_OUTBOUND.RCRA_CERT
    /

create synonym NODE_RCRA_ENVPERMIT for RCRA_OUTBOUND.RCRA_ENVPERMIT
    /

create synonym NODE_RCRA_HANDLERWASTECODE for RCRA_OUTBOUND.RCRA_HANDLERWASTECODE
    /

create synonym NODE_RCRA_UNVWASTEACT for RCRA_OUTBOUND.RCRA_UNVWASTEACT
    /

create synonym NODE_RCRA_STATEACT for RCRA_OUTBOUND.RCRA_STATEACT
    /

create synonym NODE_RCRA_FACOWNROPER for RCRA_OUTBOUND.RCRA_FACOWNROPER
    /

create synonym NODE_RCRA_HZRDSECONDARYMTRLACT for RCRA_OUTBOUND.RCRA_HZRDSECONDARYMTRLACT
    /

create synonym NODE_RCRA_OTHERID for RCRA_OUTBOUND.RCRA_OTHERID
    /

create synonym NODE_RCRA_WASTEGENRTR for RCRA_OUTBOUND.RCRA_WASTEGENRTR
    /

create synonym NODE_RCRA_PERMITFACSUB for RCRA_OUTBOUND.RCRA_PERMITFACSUB
    /

create synonym NODE_RCRA_PERMITSERIES for RCRA_OUTBOUND.RCRA_PERMITSERIES
    /

create synonym NODE_RCRA_PERMITUNIT for RCRA_OUTBOUND.RCRA_PERMITUNIT
    /

create synonym NODE_RCRA_PERMITUNITDETAIL for RCRA_OUTBOUND.RCRA_PERMITUNITDETAIL
    /

create synonym NODE_RCRA_PERMITEVENT for RCRA_OUTBOUND.RCRA_PERMITEVENT
    /

create synonym NODE_RCRA_EVENTCOMMIT for RCRA_OUTBOUND.RCRA_EVENTCOMMIT
    /

create synonym NODE_RCRA_PERMITRELEVENT for RCRA_OUTBOUND.RCRA_PERMITRELEVENT
    /

create synonym NODE_RCRA_FINASSURFACSUB for RCRA_OUTBOUND.RCRA_FINASSURFACSUB
    /

create synonym NODE_RCRA_MECH for RCRA_OUTBOUND.RCRA_MECH
    /

create synonym NODE_RCRA_MECHDETAIL for RCRA_OUTBOUND.RCRA_MECHDETAIL
    /

create synonym NODE_RCRA_COSTEST for RCRA_OUTBOUND.RCRA_COSTEST
    /

create synonym NODE_RCRA_COSTESTRELMECH for RCRA_OUTBOUND.RCRA_COSTESTRELMECH
    /

create synonym NODE_RCRA_CORRACTFACSUB for RCRA_OUTBOUND.RCRA_CORRACTFACSUB
    /

create synonym NODE_RCRA_CORRACTEVENT for RCRA_OUTBOUND.RCRA_CORRACTEVENT
    /

create synonym NODE_RCRA_CORRACTAREA for RCRA_OUTBOUND.RCRA_CORRACTAREA
    /

create synonym NODE_RCRA_CORRACTAUTH for RCRA_OUTBOUND.RCRA_CORRACTAUTH
    /

create synonym NODE_RCRA_CORRACTRELEVENT for RCRA_OUTBOUND.RCRA_CORRACTRELEVENT
    /

create synonym NODE_RCRA_CORRACTSTATCITN for RCRA_OUTBOUND.RCRA_CORRACTSTATCITN
    /

create synonym NODE_RCRA_CORRACTRELPERMITUNIT for RCRA_OUTBOUND.RCRA_CORRACTRELPERMITUNIT
    /

create synonym NODE_RCRA_CMEFACSUB for RCRA_OUTBOUND.RCRA_CMEFACSUB
    /

create synonym NODE_RCRA_VIO for RCRA_OUTBOUND.RCRA_VIO
    /

create synonym NODE_RCRA_EVAL for RCRA_OUTBOUND.RCRA_EVAL
    /

create synonym NODE_RCRA_ENFRCACT for RCRA_OUTBOUND.RCRA_ENFRCACT
    /

create synonym NODE_RCRA_EVALCOMMIT for RCRA_OUTBOUND.RCRA_EVALCOMMIT
    /

create synonym NODE_RCRA_EVALVIO for RCRA_OUTBOUND.RCRA_EVALVIO
    /

create synonym NODE_RCRA_CITN for RCRA_OUTBOUND.RCRA_CITN
    /

create synonym NODE_RCRA_CSNYDATE for RCRA_OUTBOUND.RCRA_CSNYDATE
    /

create synonym NODE_RCRA_MEDIA for RCRA_OUTBOUND.RCRA_MEDIA
    /

create synonym NODE_RCRA_MLSTN for RCRA_OUTBOUND.RCRA_MLSTN
    /

create synonym NODE_RCRA_REQUEST for RCRA_OUTBOUND.RCRA_REQUEST
    /

create synonym NODE_RCRA_SUPPENVPROJ for RCRA_OUTBOUND.RCRA_SUPPENVPROJ
    /

create synonym NODE_RCRA_VIOENFRC for RCRA_OUTBOUND.RCRA_VIOENFRC
    /

create synonym NODE_RCRA_PENALTY for RCRA_OUTBOUND.RCRA_PENALTY
    /

create synonym NODE_RCRA_PAYMNT for RCRA_OUTBOUND.RCRA_PAYMNT
    /

create synonym NODE_RCRA_GISFACSUB for RCRA_OUTBOUND.RCRA_GISFACSUB
    /

create synonym NODE_RCRA_GEOGINF for RCRA_OUTBOUND.RCRA_GEOGINF
    /

create synonym NODE_RCRA_GEOGMETA for RCRA_OUTBOUND.RCRA_GEOGMETA
    /

create synonym NODE_RCRA_WHERETYPE for RCRA_OUTBOUND.RCRA_WHERETYPE
    /

create synonym NODE_RCRA_AREAACREAGE for RCRA_OUTBOUND.RCRA_AREAACREAGE
    /

create synonym NODE_RCRA_REPORTUNIV for RCRA_OUTBOUND.RCRA_REPORTUNIV
    /

create synonym NODE_RCRA_HANDLERLQGCLOSURE for RCRA_OUTBOUND.RCRA_HANDLERLQGCLOSURE
    /

create synonym NODE_RCRA_HANDLERLQGCONSOLID for RCRA_OUTBOUND.RCRA_HANDLERLQGCONSOLIDATION
    /

create synonym NODE_RCRA_EPISODICWASTE for RCRA_OUTBOUND.RCRA_EPISODICWASTE
    /

create synonym NODE_RCRA_HANDLEREPISODICEVENT for RCRA_OUTBOUND.RCRA_HANDLEREPISODICEVENT
    /

create synonym NODE_RCRA_PRM_MOD_EVENT for RCRA_OUTBOUND.RCRA_PRM_MOD_EVENT
    /
...
create synonym NODE_RCRA_CME_SUBM_DEL for RCRA_OUTBOUND.RCRA_CME_SUBM_DEL
    /

create synonym NODE_RCRA_CME_FAC_SUBM_DEL for RCRA_OUTBOUND.RCRA_CME_FAC_SUBM_DEL
    /
...
create synonym NODE_RCRA_CME_ENFRC_ACT_DEL for RCRA_OUTBOUND.RCRA_CME_ENFRC_ACT_DEL
    /
...
create synonym NODE_RCRA_CME_EVAL_DEL for RCRA_OUTBOUND.RCRA_CME_EVAL_DEL
    /
...
create synonym NODE_RCRA_CME_VIOL_DEL for RCRA_OUTBOUND.RCRA_CME_VIOL_DEL
    /
...
create synonym NODE_RCRA_HD_EPISODIC_PRJT for RCRA_OUTBOUND.RCRA_HD_EPISODIC_PRJT
    /
