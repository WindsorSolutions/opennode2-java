...
public class SolicitOpCEDeletesByState extends SolicitOperation {

    public static final String SERVICE_NAME = "SolicitOpCEDeletesByState";
    ...
    static {
        ...
        PLUGIN_SERVICE_IMPLEMENTOR_DESCRIPTOR.setDescription("Solicits CE Delete Data by State from the RCRAInfo service.");
    ...
    public SolicitRequestType getRequestType() {
        return SolicitRequestType.CE_DELETES_BY_STATE;
    }
    ...
    public SolicitRequest handleGetRequest(SolicitRequestFactory requestFactory, ByIndexOrNameMap namedParams)
        ...
        String state = namedParams.get(PARAM_STATE_REQ.getName()).toString();
        String changeDate = namedParams.get(PARAM_CHANGE_DATE.getName()).toString();
        ...
        return requestFactory.getCEDeletesByState(state, changeDate);
    }
