...
public class SolicitOpEMByHandler extends SolicitOperation {

    public static final String SERVICE_NAME = "SolicitOpEMByHandler";
    ...
    static {
        ...
        PLUGIN_SERVICE_IMPLEMENTOR_DESCRIPTOR.setDescription("Solicits EManifest Data by Handler from the RCRAInfo service.");
    ...
    public SolicitRequestType getRequestType() {
        return SolicitRequestType.EM_BY_HANDLER;
    }
    ...
    public SolicitRequest handleGetRequest(SolicitRequestFactory requestFactory, ByIndexOrNameMap namedParams)
        ...
        String handlerId = namedParams.get(PARAM_HANDLER_ID_REQ.getName()).toString();
        ...
        return requestFactory.getEMDataByHandler(handlerId, changeDate);
    }
