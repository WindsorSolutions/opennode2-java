...
public class SolicitRequestFactory {
    ...
    public SolicitRequest getCHDataByHandler(String handlerId, Date changeDate) {
        return createForHandler(SolicitRequestType.CH_BY_HANDLER, handlerId, changeDate);
    }

    public SolicitRequest getCHDataByHandler(String handlerId, String changeDate) {
        return createForHandler(SolicitRequestType.CH_BY_HANDLER, handlerId, changeDate);
    }

    public SolicitRequest getCHDataByState(String state, Date changeDate) {
        return createForState(SolicitRequestType.CH_BY_STATE, state, changeDate);
    }

    public SolicitRequest getCHDataByState(String state, String changeDate) {
        return createForState(SolicitRequestType.CH_BY_STATE, state, changeDate);
    }

    public SolicitRequest getEMDataByHandler(String handlerId, Date changeDate) {
        return createForHandler(SolicitRequestType.EM_BY_HANDLER, handlerId, changeDate);
    }

    public SolicitRequest getEMDataByHandler(String handlerId, String changeDate) {
        return createForHandler(SolicitRequestType.EM_BY_HANDLER, handlerId, changeDate);
    }

    public SolicitRequest getEMDataByState(String state, Date changeDate) {
