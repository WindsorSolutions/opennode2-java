...
public class SolicitOpHDByHandler extends SolicitOperation {
    ...
    public SolicitRequest handleGetRequest(SolicitRequestFactory requestFactory, ByIndexOrNameMap namedParams)
        ...
        String state = namedParams.get(PARAM_STATE.getName()).toString();
        String sourceType = namedParams.get(PARAM_SOURCE_TYPE.getName()).toString();
        String sequenceNumber = namedParams.get(PARAM_SEQUENCE_NUMBER.getName()).toString();
