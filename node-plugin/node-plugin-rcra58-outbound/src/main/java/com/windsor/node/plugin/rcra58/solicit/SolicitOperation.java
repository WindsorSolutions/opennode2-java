...
import com.windsor.node.plugin.rcra58.PendingSubmissionInProgressException;
import com.windsor.node.plugin.rcra58.RcraOutboundException;
import com.windsor.node.plugin.rcra58.domain.SolicitHistory;
import com.windsor.node.plugin.rcra58.outbound.BaseRcraPlugin;
...
import com.windsor.node.plugin.rcra58.status.GetStatusRequest;
 ...
 */
public abstract class SolicitOperation extends BaseRcraPlugin {
    ...
    public SolicitRequest getRequest(SolicitRequestFactory requestFactory, ByIndexOrNameMap namedParams) throws RcraOutboundException {
    ...
    public ProcessContentResult process(NodeTransaction transaction) {
        ...
        } catch(RcraOutboundException exception) {
