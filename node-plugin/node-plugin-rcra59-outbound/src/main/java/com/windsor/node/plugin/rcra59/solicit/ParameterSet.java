...
import static com.windsor.node.plugin.rcra59.outbound.BaseRcraPlugin.PARAM_END_DATE;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_AGENCY;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_CHANGE_DATE;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_FROM_DATE;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_HANDLER_ID_REQ;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_OWNER;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_SEQUENCE_NUMBER;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_SOURCE_TYPE;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_STATE;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_STATE_REQ;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_TO_DATE;
import static com.windsor.node.plugin.rcra59.solicit.SolicitOperation.PARAM_USE_SOLICIT_HISTORY;
