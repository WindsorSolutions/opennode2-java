package com.windsor.node.plugin.rcra59.outbound;
...
/**
 * Provides the common functionality for the RCRA v5.6 plugin.
 */
public abstract class BaseRcraPlugin extends BaseWnosJaxbPlugin implements DisposableBean {
    ...
    public BaseRcraPlugin() {
        ...
        debug(BaseRcraPlugin.class.getSimpleName() + " instantiated.");
    }
	...
	public void afterPropertiesSet() {
        ...
        EntityManagerFactory emf = provider.createEntityManagerFactory(
                ...
                new PluginPersistenceConfig()
                        ...
                        .rootEntityPackage("com.windsor.node.plugin.rcra59.domain")
                        .additionalEntityPackages(
                                "net.opengis.gml",
                                //"org.georss.georss._10",
                                "com.windsor.node.plugin.rcra59.converter")
