...
public class StreamXmlFileGenerator implements DocumentGenerator {
   private final FileCreator fileCreator;
   private final ElementsDataProvider dataProvider;
   private final ElementWriter writer;
   private final ElementWriteHandler writeHandler;

   public StreamXmlFileGenerator(FileCreator fileCreator, ElementsDataProvider dataProvider, ElementWriteHandler writeHandler, ElementWriter writer) {
   ...
   public File generate() throws IOException {
      ...
      try {
         ...
         while(i$.hasNext()) {
            Object t = i$.next();
            this.writeHandler.handle(this.writer, t);
         }
