...
public class SolicitOpCHByState extends SolicitOperation {

    public static final String SERVICE_NAME = "SolicitOpCHByState";
    ...
    static {
        ...
        PLUGIN_SERVICE_IMPLEMENTOR_DESCRIPTOR.setDescription("Solicits Current Handler Data by State from the RCRAInfo service.");
    ...
    public SolicitRequest handleGetRequest(SolicitRequestFactory requestFactory, ByIndexOrNameMap namedParams)
        ...
        return requestFactory.getCHDataByState(state, changeDate);
    }
