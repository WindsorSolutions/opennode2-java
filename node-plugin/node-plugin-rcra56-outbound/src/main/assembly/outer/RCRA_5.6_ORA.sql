...
(
	...
	CONTACTADDRESSID NUMBER(19)
		...
		references RCRA_CONTACTADDRESS,
	WASTEGENTRID NUMBER(19),
	EPISODICEVENTID NUMBER(19),
	LQGCLOSUREID NUMBER(19),
	LQGCONSOLIDATIONID NUMBER(19),
...
alter table RCRA_HANDLER
	add constraint FK_PDR1WOKNWYEKSMFPMVUG8L9TX
foreign key (LQGCONSOLIDATIONID) references RCRA_HANDLERLQGCONSOLIDATION
;
...
(
	HZRDSECONDARYMTRLID NUMBER(19) not null
		constraint FK_TDWKVM9C2AF0PH6X9YQ0LUJ49
		references RCRA_HZRDSECONDARYMTRL,
...
(
	HZRDSECONDARYMTRLID NUMBER(19) not null
		constraint FK_6UTLPMA1K82FIMV86FBA92D55
		references RCRA_HZRDSECONDARYMTRL,
...
alter table RCRA_HANDLER
	add constraint FK_JA8ITMOP1ATYA2ENUTY9CYA3J
foreign key (WASTEGENTRID) references RCRA_WASTEGENRTR
;
