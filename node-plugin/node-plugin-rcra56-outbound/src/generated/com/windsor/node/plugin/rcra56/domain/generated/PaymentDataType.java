...
@XmlType(name = "PaymentDataType", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", propOrder = {
    "transactionCode",
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @XmlElement(name = "PaymentSequenceNumber", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    protected BigInteger paymentSequenceNumber;
    @XmlElement(name = "PaymentDefaultedDate", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected XMLGregorianCalendar paymentDefaultedDate;
    @XmlElement(name = "ScheduledPaymentDate", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected XMLGregorianCalendar scheduledPaymentDate;
    @XmlElement(name = "ScheduledPaymentAmount", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected BigDecimal scheduledPaymentAmount;
    @XmlElement(name = "ActualPaymentDate", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected XMLGregorianCalendar actualPaymentDate;
    @XmlElement(name = "ActualPaidAmount", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    ...
    @Transient
    public boolean isSetPaymentSequenceNumber() {
        return (this.paymentSequenceNumber!= null);
    }
    ...
    @Transient
    public boolean isSetPaymentDefaultedDate() {
        return (this.paymentDefaultedDate!= null);
    }
    ...
    @Transient
    public boolean isSetScheduledPaymentDate() {
        return (this.scheduledPaymentDate!= null);
    }
    ...
    @Transient
    public boolean isSetScheduledPaymentAmount() {
        return (this.scheduledPaymentAmount!= null);
    }
    ...
    @Transient
    public boolean isSetActualPaymentDate() {
        return (this.actualPaymentDate!= null);
    }
    ...
    @Transient
    public boolean isSetActualPaidAmount() {
        return (this.actualPaidAmount!= null);
    }
