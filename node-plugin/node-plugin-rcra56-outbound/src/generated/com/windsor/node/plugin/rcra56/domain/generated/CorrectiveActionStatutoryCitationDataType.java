...
@XmlType(name = "CorrectiveActionStatutoryCitationDataType", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", propOrder = {
    "transactionCode",
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @XmlElement(name = "StatutoryCitationDataOwnerCode", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    protected String statutoryCitationDataOwnerCode;
    @XmlElement(name = "StatutoryCitationIdentifier", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    protected String statutoryCitationIdentifier;
    @XmlElement(name = "StatutoryCitationDescription", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    ...
    @Transient
    public boolean isSetStatutoryCitationDataOwnerCode() {
        return (this.statutoryCitationDataOwnerCode!= null);
    }
    ...
    @Transient
    public boolean isSetStatutoryCitationIdentifier() {
        return (this.statutoryCitationIdentifier!= null);
    }
     ...
     */
    @Basic
    @Column(name = "STATCITNDESC", length = 4000)
    ...
    @Transient
    public boolean isSetStatutoryCitationDescription() {
        return (this.statutoryCitationDescription!= null);
    }
