...
@XmlType(name = "ViolationEnforcementDataType", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", propOrder = {
    "transactionCode",
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @XmlElement(name = "ReturnComplianceScheduledDate", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    ...
    @Transient
    public boolean isSetReturnComplianceScheduledDate() {
        return (this.returnComplianceScheduledDate!= null);
    }
