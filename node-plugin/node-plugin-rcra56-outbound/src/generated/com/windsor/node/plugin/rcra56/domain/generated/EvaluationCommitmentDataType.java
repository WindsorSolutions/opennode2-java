...
@XmlType(name = "EvaluationCommitmentDataType", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", propOrder = {
    "transactionCode",
    "commitmentLead",
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @XmlElement(name = "CommitmentLead", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    protected String commitmentLead;
    @XmlElement(name = "CommitmentSequenceNumber", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    ...
    @Transient
    public boolean isSetCommitmentLead() {
        return (this.commitmentLead!= null);
    }
    ...
    @Transient
    public boolean isSetCommitmentSequenceNumber() {
        return (this.commitmentSequenceNumber!= null);
    }
