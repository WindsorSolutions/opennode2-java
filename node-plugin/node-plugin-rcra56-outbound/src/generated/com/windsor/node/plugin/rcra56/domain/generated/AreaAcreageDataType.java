...
@XmlType(name = "AreaAcreageDataType", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", propOrder = {
    "areaAcreageMeasure",
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @XmlElement(name = "AreaAcreageMeasure", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    protected BigDecimal areaAcreageMeasure;
    @XmlElement(name = "AreaMeasureSourceDataOwnerCode", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    protected String areaMeasureSourceDataOwnerCode;
    @XmlElement(name = "AreaMeasureSourceCode", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    protected String areaMeasureSourceCode;
    @XmlElement(name = "AreaMeasureSourceText", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected String areaMeasureSourceText;
    @XmlElement(name = "AreaMeasureDate", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    ...
    @Transient
    public boolean isSetAreaAcreageMeasure() {
        return (this.areaAcreageMeasure!= null);
    }
    ...
    @Transient
    public boolean isSetAreaMeasureSourceDataOwnerCode() {
        return (this.areaMeasureSourceDataOwnerCode!= null);
    }
    ...
    @Transient
    public boolean isSetAreaMeasureSourceCode() {
        return (this.areaMeasureSourceCode!= null);
    }
     ...
     */
    @Basic
    @Column(name = "AREAMSRSOURCETXT", length = 4000)
    ...
    @Transient
    public boolean isSetAreaMeasureSourceText() {
        return (this.areaMeasureSourceText!= null);
    }
    ...
    @Transient
    public boolean isSetAreaMeasureDate() {
        return (this.areaMeasureDate!= null);
    }
