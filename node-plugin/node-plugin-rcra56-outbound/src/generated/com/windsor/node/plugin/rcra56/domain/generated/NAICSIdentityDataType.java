...
@XmlType(name = "NAICSIdentityDataType", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", propOrder = {
    "transactionCode",
    "naicsSequenceNumber",
    "naicsOwnerCode",
    "naicsCode",
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @XmlElement(name = "NAICSSequenceNumber", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    protected String naicsSequenceNumber;
    @XmlElement(name = "NAICSOwnerCode", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected String naicsOwnerCode;
    @XmlElement(name = "NAICSCode", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected String naicsCode;
    @XmlElement(name = "NAICSText", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    ...
    @Transient
    public boolean isSetNAICSSequenceNumber() {
        return (this.naicsSequenceNumber!= null);
    }
    ...
    @Transient
    public boolean isSetNAICSOwnerCode() {
        return (this.naicsOwnerCode!= null);
    }
     ...
     */
    @Basic
    @Column(name = "NAICSTXT", length = 4000)
    ...
    @Transient
    public boolean isSetNAICSText() {
        return (this.naicsText!= null);
    }
