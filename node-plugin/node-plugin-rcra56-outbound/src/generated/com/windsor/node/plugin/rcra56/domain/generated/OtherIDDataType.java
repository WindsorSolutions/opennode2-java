...
@XmlType(name = "OtherIDDataType", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", propOrder = {
    "transactionCode",
    "otherHandlerID",
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @XmlElement(name = "OtherHandlerID", namespace = "http://www.exchangenetwork.net/schema/RCRA/5", required = true)
    protected String otherHandlerID;
    @XmlElement(name = "RelationshipOwnerName", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected String relationshipOwnerName;
    @XmlElement(name = "RelationshipTypeCode", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected String relationshipTypeCode;
    @XmlElement(name = "RelationshipTypeText", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected String relationshipTypeText;
    @XmlElement(name = "SameFacilityIndicator", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    protected String sameFacilityIndicator;
    @XmlElement(name = "OtherIDSupplementalInformationText", namespace = "http://www.exchangenetwork.net/schema/RCRA/5")
    ...
    @Transient
    public boolean isSetOtherHandlerID() {
        return (this.otherHandlerID!= null);
    }
    ...
    @Transient
    public boolean isSetRelationshipOwnerName() {
        return (this.relationshipOwnerName!= null);
    }
    ...
    @Transient
    public boolean isSetRelationshipTypeCode() {
        return (this.relationshipTypeCode!= null);
    }
     ...
     */
    @Basic
    @Column(name = "RELTYPETXT", length = 4000)
    ...
    @Transient
    public boolean isSetRelationshipTypeText() {
        return (this.relationshipTypeText!= null);
    }
    ...
    @Transient
    public boolean isSetSameFacilityIndicator() {
        return (this.sameFacilityIndicator!= null);
    }
    ...
    @Transient
    public boolean isSetOtherIDSupplementalInformationText() {
        return (this.otherIDSupplementalInformationText!= null);
    }
