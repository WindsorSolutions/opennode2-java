package com.windsor.node.plugin.rcra56.domain;

import com.windsor.node.common.domain.PluginServiceImplementorDescriptor;
import com.windsor.node.common.domain.RequestType;
import com.windsor.node.common.domain.ServiceType;
import com.windsor.node.plugin.rcra56.service.RCRACmeExtractAndSubmission;
import com.windsor.node.plugin.rcra56.service.RCRACorrectiveActionExtractAndSubmission;
import com.windsor.node.plugin.rcra56.service.RCRAFinancialAssuranceExtractAndSubmission;
import com.windsor.node.plugin.rcra56.service.RCRAGisExtractAndSubmission;
import com.windsor.node.plugin.rcra56.service.RCRAHandlerExtractAndSubmission;
import com.windsor.node.plugin.rcra56.service.RCRAPermittingExtractAndSubmission;

public enum OperationType {

    CME(new PluginServiceImplementorDescriptor("Submit RCRA CME Data",
            "Flow RCRA CME data", "5.6",
    ...
    CORRECTIVE_ACTION(new PluginServiceImplementorDescriptor("Submit RCRA Corrective Action Data",
            "Flow RCRA corrective action data", "5.6",
    ...
    FINANCIAL_ASSURANCE(new PluginServiceImplementorDescriptor("Submit RCRA Financial Assurance Data",
            "Flow RCRA financial assurance data", "5.6",
    ...
    GET_STATUS(new PluginServiceImplementorDescriptor("Get Status",
            "Get status for pending submissions", "5.6",
            RCRAPermittingExtractAndSubmission.class.getCanonicalName()),
    		null,
    		null,
