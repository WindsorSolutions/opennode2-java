...
import com.windsor.node.plugin.rcra56.domain.HandlerDataType;
import com.windsor.node.plugin.rcra56.dao.RcraDao;
import com.windsor.node.plugin.rcra56.dao.RcraDaoJpaImpl;
    ...
    public void afterPropertiesSet() {
        ...
        EntityManagerFactory emf = provider.createEntityManagerFactory(getDataSources().get(ARG_DS_SOURCE),
                new PluginPersistenceConfig()
                        ...
                        .rootEntityPackage("com.windsor.node.plugin.rcra56.domain")
