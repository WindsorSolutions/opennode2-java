...
public class ExchangeFormPanel extends ModalizablePanel<EditExchangeBean> {
    ...
    public ExchangeFormPanel(final String id, IModel<EditExchangeBean> model) {
        ...
        form.add(new Label("labelFiles",
                new IdentifiableResourceModel(NodeResourceModelKeys.LABEL_FILES)));
        ...
        form.add(new RequirableFormGroup("filesAgeGroup")
                .add(new TextField<>("field", EditExchangeBeanModels.bindAutoDeleteFileAge(getModel()))
                        .add(new InputBehavior()))
                .add(new Label("label", new IdentifiableResourceModel(NodeResourceModelKeys.LABEL_FILES_AGE))));
